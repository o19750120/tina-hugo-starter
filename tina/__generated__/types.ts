...
export type PostPartsFragment = { __typename: 'Post', title: string, date?: string | null, draft?: boolean | null, body?: any | null };
...
export type PostQuery = { __typename?: 'Query', post: { __typename: 'Post', id: string, title: string, date?: string | null, draft?: boolean | null, body?: any | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } };
...
export const ExperimentalGetTinaClient = () =>
  getSdk(
    generateRequester(
      createClient({
        url: "https://content.tinajs.io/1.4/content/761988e8-8c14-4bd0-8cc5-eba575b23a03/github/main",
        queries,
      })
    )
  )
